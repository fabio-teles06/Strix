#ifndef STRIX_HANDLE_LIST_H
#define STRIX_HANDLE_LIST_H
...
namespace strix
{
    ...
    //
    template <typename T>
    HandleList<T>::HandleList(int initialCapacity) : slots(sizeof(SlotInfo) * initialCapacity),
